      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: 10,
            borderRadius: "50%",
            background: "radial-gradient(circle at 35% 30%, #fff7a0 0%, #f5d800 60%, #8a7000 100%)",
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "inset 0 0 20px rgba(20,10,80,0.6), inset 0 0 2px rgba(255,255,255,0.2)",
          }}
        >
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    boxShadow: isSel ? `0 0 8px ${c}, 0 0 14px #fff` : `0 0 4px rgba(0,0,0,0.5)`,
                    border: "none",
                    cursor: "pointer",
                    padding: 0,
                  }}
...
function Bubble({ x, y, r, opacity }: { x: number; y: number; r: number; opacity: number }) {
  return (
    <div
...
function MenuButton({ children }: { children: React.ReactNode }) {
  return (
    <div
      style={{
        padding: "4px 14px",
        background: "linear-gradient(180deg, rgba(80,70,180,0.5) 0%, rgba(30,20,100,0.6) 100%)",
        border: "2px solid #6a7fe5",
        fontFamily: "Arial Black, Arial, sans-serif",
        fontWeight: 900,
        fontSize: 14,
